    ...
    resetValues(){
        ...
        this.rotate=0;
            ...
            render(){
                ...
                var h = this.h;
                var w = this.w;
                var parentWidth = Number(this.parent.style.width.replace("px",""))-20;
                var parentHeight = Number(this.parent.style.height.replace("px",""))-20;
                if(this.extendH && this.extendV){
                    ...
                    this.parent.style.overflowX="scroll";
